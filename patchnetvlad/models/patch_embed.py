...
# patchify block, patch embedding of vanilla ViT, SAIG, and TIMM HybridViT
...
class MiniEncoder(nn.Module):
    '''
        ...
        FIXME: the feature dimension is too large given the limited memory
    '''
